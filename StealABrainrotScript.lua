...
--==================================================
-- TELEPORT TO SAFE POSITION (BASE-LIKE)
--==================================================
local function TeleportSafe()
    local hrp = GetChar():WaitForChild("HumanoidRootPart")
    hrp.CFrame = CFrame.new(0, 200, 0) -- всегда работает
end
...
frame.Size = UDim2.fromScale(0.28,0.4)
...
Button("FLY",0.27,function()
    Settings.Fly = not Settings.Fly
end)

Button("NOCLIP",0.49,function()
    Settings.Noclip = not Settings.Noclip
end)

Button("TP SAFE",0.71,function()
    TeleportSafe()
end)
...
arrow.MouseButton1Click:Connect(function()
    ...
    TweenService:Create(frame,TweenInfo.new(0.25),{
        Size = collapsed and UDim2.fromScale(0.28,0.18) or UDim2.fromScale(0.28,0.4)
    }):Play()
